...
const Course = ({course,handleAddToBookmark}) => {
    ...
    return (
        <div className='mb-4 mr-4 p-4 text-center w-[312px] h-[402px] shadow-2xl rounded-xl'>
            ...
            <h2 className="text-xl font-semibold mt-2">{course_name}</h2>
            <p>{course_details}</p>
            ...
            <button onClick={()=>handleAddToBookmark(course,course_credit)} className='bg-blue-500 text-white p-3 rounded-xl mt-4 w-full'>Select</button>
